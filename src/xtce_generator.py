...
while we do try to stay 100%-compliant to XTCE, we use our XTCE files with YAMCS[3]. Thus we lean towaards YAMCS-flavor
...
class XTCEManager:
    ...
    def __get_basetype_name(self, basename: str, bit_size: int, little_endian: bool):
        ...
        if typename in all_basetypes:
            out_type_ref = XTCEManager.BASE_TYPE_NAMESAPCE + '/' + typename
        else:
            logging.warning(f'{typename} was looked up as a base type, but it was not found in the BaseType namespace. ')
