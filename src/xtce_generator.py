...
class XTCEManager:
    ...
    def __init__(self, root_space_system: str, file_name: str, sqlite_path: str, config: dict,
...
def generate_xtce(database_path: str, config_yaml: dict, output_dir: str, root_spacesystem: str = 'airliner',
                  log_level: str = '0'):
    """
    ...
    if output_dir:
        xtce_obj = XTCEManager(root_spacesystem, root_spacesystem + '.xml', database_path, config_yaml,
