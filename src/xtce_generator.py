...
def generate_xtce(database_path: str, config_yaml: dict, root_spacesystem: str = 'airliner', log_level: str = '0'):
    """
...
def main():
    ...
    generate_xtce(args.sqlite_path, config_data, args.spacesystem, args.log_level)
